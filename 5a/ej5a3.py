...
class SafeWalletCredentials:
    def __init__(self,password):
        ...
        # Informamos "password como variable privada, para que no pueda ser modificada desde fuera."
        # Solo podrá ser modificada usando el metodo set_password()
...
pedro_wallet.__password = "12"
print("last",pedro_wallet.get_password())
